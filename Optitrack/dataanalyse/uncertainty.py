    ...
    with torch.no_grad():
        for inputs, targets in test_loader:
            ...
            if data_variance is not None and model_variance_nm is not None:
                outputs_variance = data_variance + model_variance_nm * 100
            elif data_variance is not None:
                outputs_variance = data_variance
            elif model_variance_nm is not None:
                outputs_variance = model_variance_nm * 100 + 1e-4
            ...
            print(outputs_variance, data_variance, model_variance_nm * 100)
