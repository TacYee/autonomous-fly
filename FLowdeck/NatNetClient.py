...
class NatNetClient:
    def __init__(self):
        ...
        self.serverIPAddress = "192.168.209.81"  # <-- working

        # This should match the multicast address listed in Motive's streaming settings.
        self.multicastAddress = "239.255.42.99"  # <-- working
        # self.multicastAddress = "192.168.209.255"
    ...
    def __createDataSocket(self, port):
        ...
        mreq = struct.pack(
            "4sl", socket.inet_aton(self.multicastAddress), socket.INADDR_ANY
        )
